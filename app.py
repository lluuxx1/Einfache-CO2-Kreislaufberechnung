...
st.caption("Berechnet die wichtigsten Zustände und Kennwerte eines CO2-Kreislaufs im subkritischen und transkritischen Betrieb.")
...
with st.expander("Anleitung"):
    st.markdown(
        """
        Dieses Tool dient zur einfachen Berechnung von CO2-Kälteanlagen und unterstützt dich bei der Bestimmung von Kreislaufpunkten, Systemdaten, Stoffdaten sowie der Rohrleitungsdimensionierung. Berücksichtigt wird eine subkritische und transkritische Prozessführung. Damit kannst du thermodynamische Zustände schnell überschlagen, Ergebnisse tabellarisch auswerten und bei Bedarf als CSV-Datei exportieren.
